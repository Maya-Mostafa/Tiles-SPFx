...
export default function ITileForm (props: ITileFormProps) {
    ...
    const iconOptions: IComboBoxOption[] = [];
            ...
            <Stack tokens={stackTokens}>
                <Stack>
                    ...
                    <Dropdown 
                        ...
                        options={colorOptions} onRenderOption={onRenderColorOption}
                        styles={dropdownStyles} onRenderTitle={onRenderColorTitle}
                        onChange={props.onChangeColorField} />
                    <Dropdown
                        placeholder="Select an icon"
                        label="Icon" selectedKey={props.iconField ? props.iconField.key : undefined}
                        ariaLabel="Icon Name"
                        onRenderTitle={onRenderIconTitle}
